    ...
    <div id="app">
                    ...
                    <div class="navbar-item dropdown has-divider has-user-avatar">
                        <a class="navbar-link">
                            <div class="user-avatar">
                                <img src="./img/owner_logo/<?php echo $_SESSION['profile_image']; ?>" alt="<?php echo $_SESSION['shipping_name']; ?>" class="rounded-full">
                            </div>
        ...
        <section class="section main-section ">
            ...
            <div class="card has-table ">
                <header class="card-header ">
                    <p class="card-header-title ">
                        <span class="icon "><i class="mdi mdi-account-multiple "></i></span> Customer
                    </p>
                    <a href="# " class="card-header-icon ">
                        <span class="icon "><i class="mdi mdi-reload "></i></span>
                    </a>
        ...
        <footer class="footer">
            <div class="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0">
                ...
                <a href="https://justboil.me">
                    <img src="img/owner_logo/logo.png" alt="" srcset="" width="160" class="rounded-2">
                </a>
            </div>
        </footer>
